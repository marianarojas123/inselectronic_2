...
function Login({ isOpen, onClose, onSwitchToRegister }) {
  ...
  return (
    <LoginOverlay isOpen={isOpen} onClick={handleClose}>
      <LoginContainer isOpen={isOpen} onClick={(e) => e.stopPropagation()}>
        <LoginHeader>
          <LoginTitle>Iniciar Sesión</LoginTitle>
          <LoginSubtitle>Bienvenido de vuelta</LoginSubtitle>
        ...
        <LoginForm onSubmit={handleSubmit}>
          ...
          <RegisterLink>
            ...
            <RegisterButton type="button" onClick={onSwitchToRegister}>
              Regístrate
            </RegisterButton>
          </RegisterLink>
        </LoginForm>
